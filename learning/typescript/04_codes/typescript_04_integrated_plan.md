...
**Total Learning Time**: 7 days, 6 hours per day
...
### Day 1: Conditional Types Fundamentals (6 hours)
**Time Allocation**:
...
### Day 2: Advanced Conditional Types + infer Keyword (6 hours)
**Time Allocation**:
- Theory Learning: 2 hours
- Programming Practice: 3 hours
...
type ExtractBlockData<T> = T extends Promise<infer U> 
  ? U extends { block: infer B } ? B : never 
  : never;
...
### Day 3: Template Literal Types (6 hours)
**Time Allocation**:
- Theory Learning: 2 hours
...
### Day 4: Advanced Type Inference + Mapped Types (6 hours)
**Time Allocation**:
...
### Day 5: Comprehensive Project - Substrate API Type System (6 hours)
**Time Allocation**:
...
### Day 6: Performance Optimization + Type-level Programming Basics (6 hours)
**Time Allocation**:
...
### Day 7: Project Integration + Testing + Interview Preparation (6 hours)
**Time Allocation**:
...
04_codes/
├── conditional/
│   ├── 04_conditional_basic.ts        # Day 1: Conditional types fundamentals
│   └── 04_conditional_advanced.ts     # Day 2: Advanced conditional types
├── template_literals/
│   └── 04_template_literals.ts        # Day 3: Template literal types
├── mapped_inference/
│   └── 04_mapped_inference.ts         # Day 4: Mapped types + inference
├── substrate_api_system/
│   └── 04_substrate_api_system.ts     # Day 5: Comprehensive project
├── optimization_type_level/
│   └── 04_optimization_type_level.ts  # Day 6: Performance + type-level programming
├── comprehensive_project/
│   └── 04_comprehensive_project.ts    # Day 7: Final integration project
