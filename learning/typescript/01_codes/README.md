...
Covers essential TypeScript concepts including basic types, interfaces, utility types, and generics.
...
├── 01_basic-types.js         # Compiled JavaScript output
├── 01_basic-types.ts         # Basic types and interface practice
├── 01_generic-practice.js
├── 01_generic-practice.ts    # Generic classes and constraints
...
### 1. Basic Types and Interfaces (`01_basic-types.ts`)
...
### 2. Generic Practice (`01_generic-practice.ts`)
...
```bash
PS E:\parity-learning\learning\typescript\01_codes> npx ts-node day01_basic-types.ts
...
```bash
PS E:\parity-learning\learning\typescript\01_codes> node 01_generic-practice.js
{ id: 1, name: 'Alice', email: 'a@a.com', isActive: true }
{ id: 2, name: 'Bob', email: 'b@b.com', isActive: false }
```

![Results](https://github.com/wls503pl/parity-learning/blob/outstanding_projects/learning/typescript/01_codes/img/01_generic_practice_result.png)
...
```
TypeError [ERR_UNKNOWN_FILE_EXTENSION]: Unknown file extension ".ts" for E:\parity-learning\learning\typescript\01_codes\01_basic-types.ts
```

![Issue](https://github.com/wls503pl/parity-learning/blob/outstanding_projects/learning/typescript/01_codes/img/01_cmd_issue_fix1.png)
...
![Solution](https://github.com/wls503pl/parity-learning/blob/outstanding_projects/learning/typescript/01_codes/img/01_cmd_issue_solved.png)
...
![Issue](https://github.com/wls503pl/parity-learning/blob/outstanding_projects/learning/typescript/01_codes/img/git_pull_push_issue.png)
...
![Solution](https://github.com/wls503pl/parity-learning/blob/outstanding_projects/learning/typescript/01_codes/img/git_pull_push_issue_solved.png)
...
cd learning/typescript/01_codes
npm install typescript ts-node @types/node
```
...
npx ts-node 01_basic-types.ts
npx ts-node 01_generic-practice.ts

# Or compile and run JavaScript
tsc 01_basic-types.ts
node 01_basic-types.js
```

---

_This README documents the learning journey and troubleshooting process for TypeScript fundamentals, serving as a reference for future blockchain development projects._
